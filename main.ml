...
let args =
  ...
  ; ("-target-triple", Set_string Platform.linux_target_triple, "set the target-triple value for the desired linux platform [default='x86_64-suse-linux']")
  ...
  ; ("--interpret-ll", Set interpret_ll, "runs each LL program through the LL interpreter (before lowering to clang code)")
